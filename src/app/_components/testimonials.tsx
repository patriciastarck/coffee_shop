...
const testimonials = [
  {
    content:
      "Desde que comecei a levar a Luna para banho e tosa aqui, ela nunca esteve tão feliz! Desde que comecei a levar a Luna para banho e tosa aqui, ela nunca esteve tão feliz! Desde que comecei a levar a Luna para banho e tosa aqui, ela nunca esteve tão feliz!O atendimento é impecável, os profissionais são super cuidadosos e sempre deixam minha peluda linda e cheirosa. Recomendo de olhos fechados!",
...
export function Testimonials() {
  ...
  return (       
      <section
        className="
        border-t-90 border-[#180f0c4b] p-4  
        py-16      
